...
export const FreelaPortalNoticias = { postTitle: "Freela: Portal de noticias", 
  post:  <P.Post>
...
export const SportApi = { postTitle: "Sports API", post:  
  <P.Post>
...
export const Financas = { postTitle: "Finanças ⭐", post:  
<P.Post>
...
export const EngSoft = { postTitle: "Trabalho - Eng Soft", post:
  <P.Post>
